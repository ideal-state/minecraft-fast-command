 ...
 * @since 1.0.0
 */
public final class IsOpPlayer implements ActionInterceptor {

    public static final IsOpPlayer INSTANCE = new IsOpPlayer();
    ...
    public boolean intercept(@NotNull CommandContext context, @NotNull CommandAction action) {
        ...
        return commandSender == null || !(commandSender instanceof Player && commandSender.isOp());
    }
}
