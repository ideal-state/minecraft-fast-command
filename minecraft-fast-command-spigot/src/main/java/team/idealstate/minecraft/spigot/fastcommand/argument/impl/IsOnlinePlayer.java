 ...
 * @since 1.0.0
 */
public final class IsOnlinePlayer implements ArgumentAcceptor {

    public static final IsOnlinePlayer INSTANCE = new IsOnlinePlayer();

    private IsOnlinePlayer() {
    }

    @Override
    public boolean acceptArgument(@NotNull CommandContext context) {
        return Bukkit.getPlayer(context.getArgument()) != null;
    }
}
