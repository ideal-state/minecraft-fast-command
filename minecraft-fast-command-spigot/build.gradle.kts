    ...
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                ...
                description.set("提供基于 hyper-command 的 bukkit 命令系统组件包")
                packaging = "jar"
                url.set("https://github.com/ideal-state/minecraft-fast-command")
                ...
                scm {
                    url.set("https://github.com/ideal-state/minecraft-fast-command")
                    tag.set(version)
                    connection.set("scm:git:git@github.com:ideal-state/minecraft-fast-command.git")
                    developerConnection.set("scm:git:git@github.com:ideal-state/minecraft-fast-command.git")
                }
